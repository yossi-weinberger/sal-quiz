...
אתר ציבורי המאפשר לבדוק בכמה דקות כמה מ־100 מוצרי "הסל של ישראל" (לאחר איחוד שורות מהמקור הממשלתי) אתה קונה בפועל — ולהשוות לשאר המשתמשים ולמחירי רמי לוי.

---

## מה האתר עושה

- עוברים על 100 מוצרי הסל הרשמי ומסמנים: **קונה בקביעות / לפעמים / לא קונה**
- בסוף מקבלים: אחוז התאמה משוקלל, עלות הסל הקבוע, השוואה לממוצע משתמשים
- השוואה לייב למחירי **רמי לוי** לפי ברקודים מהסל — לרוב המוצרים נמצא התאמה
...
app/                    # Next.js App Router
  page.tsx              # דף נחיתה
  survey/page.tsx       # הסקר (100 מוצרים)
