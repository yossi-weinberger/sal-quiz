...
אתר ציבורי המאפשר לבדוק בכמה דקות כמה מ־102 מוצרי "הסל של ישראל" שפרסמה הממשלה אתה קונה בפועל — ולהשוות לשאר המשתמשים ולמחירי רמי לוי.

---

## מה האתר עושה

- עוברים על 102 מוצרי הסל הרשמי ומסמנים: **קונה בקביעות / לפעמים / לא קונה**
...
app/                    # Next.js App Router
  page.tsx              # דף נחיתה
  survey/page.tsx       # הסקר (102 מוצרים)
